...
module.exports = {
    entry:{
        ...
        vendors:['vue','vue-router','mint-ui','vue-preview','vue-resource','vuex','moment']
    }, // 入口文件
    output: { // 指定输出选项
    ...
    module: { // 配置所有第三方loader 模块的
        rules: [ // 第三方模块的匹配规则
            ...
            { test: /\.(jpg|png|gif|bmp|jpeg)$/, use: 'url-loader?limit=7631&name=images/[hash:8]-[name].[ext]' }, // 处理 图片路径的 loader
